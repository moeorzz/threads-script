...
* @param map map参数表
* key分别为：<br/>
* type : OCR类型，值分别为 OCR , paddleOcrNcnnV5 = ncnn版本的PPOCR-V5模型, paddleLiteOcr=paddleLite，  paddleOcrOnnxV4=onnx实现的PPOCR-V4模型，paddleOcrOnnxV5=onnx实现的PPOCR-V5模型， tess = Tesseract模块，baiduOnline=百度在在线识别模块，paddleocr=百度离线的paddleocr，easyedge=百度AI OCR<br/>
